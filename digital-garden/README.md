...
```npx create-docusaurus@latest digital-garden classic --typescript```
...
## API for docusaurus-config
- [docusaurus.config.js API Guide](https://docusaurus.io/docs/api/docusaurus-config)